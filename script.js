...
function darkBouncyTypeWriter(el, text, speed = 50) {
    ...
    function typeLine() {
        ...
        let chars = Array.from(lines[lineIndex]); // handles emojis correctly
        let i = 0;
        ...
        let lineTimer = setInterval(() => {
            ...
            if (i >= chars.length) {
                ...
                el.appendChild(document.createElement("br")); // space after line
                lineIndex++;
                setTimeout(typeLine, speed); // delay before next line
            }
        }, speed);
    }
...
// ===============================
// ✨ GLOWING TYPEWRITER (FOR SAD SCREENS)
// ===============================
